...
// images
import poster from '../../images/page3/poster.jpg'
...
(function ($, win) {
    ...
    try {
        jwplayer('jw_video').setup({
            file: 'https://video.cgtn.com/news/304d6a4e31677a6333566d54/video/838d4772-005e-44cc-8955-a0fd1b135841/838d4772-005e-44cc-8955-a0fd1b135841.m3u8',
            image: poster,
            skin: {
                name: 'nk-player'
            },
    ...
    //     let title = config.page3.title,
    //         description = config.page3.desc,
    //         imgUrl = config.page3.thumb,
    //         shareUrl = config.page3.url
